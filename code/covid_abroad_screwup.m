...
datePrev = cellfun(@(x) datetime(x(1:10)),ttPrev.Date);
...
tt = readtable('~/Downloads/abroad_prev.csv','HeaderLines',1,'ReadVariableNames',true,'Delimiter',',');
date = cellfun(@(x) datetime(x(1:10)),tt.Date);

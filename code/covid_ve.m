...
for ii = 1:month(datetime('today'))
    ...
    if ii < 8
        ...
        ve3(ii,1) = 100*(1-(nanmean(cases.verified_amount_vaccinated(cOld & im))...
            ./nanmean(cases.verified_not_vaccinated_normalized(cOld & im))));
        ve3(ii,2) = 100*(1-(mean(severe.serious_vaccinated_normalized(cOld & im))...
            ./mean(severe.serious_not_vaccinated_normalized(cOld & im))));
        ve3(ii,3) = 100*(1-(mean(deathsm.death_vaccinated_normalized(cOld & im))...
            ./mean(deathsm.death_not_vaccinated_normalized(cOld & im))));
    end
end
ve2(5:6,:) = nan;

...
h(3) = plot(listD.date(1:end-1)+12,movmean(listD.tests_positive(1:end-1),[3 3])/120,'k','linewidth',1);
...
h(6) = plot(listD.date(2:end-2)+3,movmean(y,[3 3])*1.5,'m','linewidth',1);
%%
grid on
grid minor
ylabel('נפטרים ליום')

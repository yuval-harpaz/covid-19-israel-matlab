...
figInf.update_yaxes(showgrid=True, gridwidth=1, gridcolor='lightgray')
...
figSev.update_yaxes(showgrid=True, gridwidth=1, gridcolor='lightgray')
...
figDeath.update_yaxes(showgrid=True, gridwidth=1, gridcolor='lightgray')

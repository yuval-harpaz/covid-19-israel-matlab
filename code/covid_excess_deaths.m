...
monthAll = readtable('lmsMonth.xlsx','Range','B11:W22','ReadVariableNames',false);
month70 = readtable('lmsMonth.xlsx','Range','B30:W41','ReadVariableNames',false);
...
pop = table((2009:2021)',...
    1000*[7485.6;7623.6;7765.8;7910.5;8059.5;8215.7;8380.1;8546.0;8713.3;8882.8;9054.0;9212.8;9500]);
% correct for medical improvement
nrm = [ones(12,1),ones(12,1),pop.Var2(2:end)/10^6,pop.Var2(2:end)/10^6];

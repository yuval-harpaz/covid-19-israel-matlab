...
figure;
subplot(2,1,2)
hs1 = plot(deaths.date(1:length(sPer)),movmean(sPer(:,2),[3 3]),'Color',[0    0.4470    0.7410]);
hold on
hd1 = plot(deaths.date(1:length(dPer)),movmean(dPer(:,2),[3 3]),'Color',[0.8500    0.3250    0.0980]);
...
ylim([0 100])
subplot(2,1,1)
hs = plot(deaths.date(1:length(sPer)),movmean(severe.total,[3 3]),'Color',[0.9290    0.6940    0.1250]);
hold on
hd = plot(deaths.date(1:length(dPer)),movmean(deaths.total,[3 3]),'k');
hsvv = plot(deaths.date(1:length(sPer)),movmean(severe{:,4},[3 3]),'Color',[0    0.4470    0.7410]);
hdv = plot(deaths.date(1:length(dPer)),movmean(deaths{:,4},[3 3]),'Color',[0.8500    0.3250    0.0980]);

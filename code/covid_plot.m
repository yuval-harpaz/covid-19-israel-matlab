function fig = covid_plot(mergedData,timeVector,nCountries,criterion,criterionDays,mustHave)
...
[isit,iMustHave] = ismember(mustHave,mergedData(:,1));
...
hAll = plot(timeVector,y,'linewidth',1,'color',[0.9 0.9 0.9]);
hold on
...
for iAnn = 1:nCountries
    txt = text(x,yt(iAnn),mergedData{order(iAnn)},...

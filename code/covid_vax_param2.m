...
tot = covid_pred_vax2(50000,datetime(2021,1,7),'steep');
tot(2,1:3) = covid_pred_vax2(100000,datetime(2021,1,7),'steep');
tot(3,1:3) = covid_pred_vax2(50000,datetime(2021,1,7),'london');
tot(4,1:3) = covid_pred_vax2(100000,datetime(2021,1,7),'london');
figure;
h = bar(tot);
